...
export function ThemeProvider({ children, theme, darkTheme }: ThemeProviderProps) {
	...
	useEffect(() => {
		...
		const themeVariableMappings: ThemeVariableMapping[] = [
			...
			{ property: '--theme-button-color', value: preferredTheme.colors?.buttonColor },
			{ property: '--theme-button-color-active', value: preferredTheme.colors?.buttonColorActive },
...
export const theme: ThemeValues = {
	colors: {
		...
		buttonColor: 'var(--theme-button-color)',
		buttonColorActive: 'var(--theme-button-color-active)',
