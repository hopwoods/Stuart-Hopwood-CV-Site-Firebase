...
export default function GithubRepo() {
	return <LazyMotion features={domAnimation} >
		<m.div initial={{ color: theme.colors.subText }} whileHover={{ color: theme.colors.brandAccentColor }} transition={{ duration: 0.3 }} className={`github ${classes.githubRepoLink} ${typography.copy3} `}>
