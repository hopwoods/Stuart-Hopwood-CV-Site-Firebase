...
export default function SocialIcons() {
	...
	return <LazyMotion features={domAnimation}>
		<m.div initial="offscreen" whileInView="onscreen" viewport={{ once: true, margin: '100px 0px 0px 0px' }} className={`socialIcons ${classes.socialIcons}`}>
			...
			<SocialLink variants={iconVariants} url='https://www.instagram.com/stoo.hopwood/' aria-label="Stuart Hopwood-Keay Instagram profile" logo={<FaInstagram />} colors={socialLinkColors} />
		</m.div>
	</LazyMotion>
};
